# Presentation Plan: Batch vs. Stream on AWS

This document outlines the structure and timing for a 20-minute presentation on Batch vs. Stream processing on AWS, followed by an interactive quiz.
...
*   **(4:00 - 5:00)** Key AWS Services for Batch
    *   Briefly mention S3, AWS Glue, Amazon EMR, and AWS Batch.
*   **(5:00 - 6:00)** Pros & Cons
...
*   **(8:00 - 9:00)** Key AWS Services for Stream
    *   Briefly mention Amazon Kinesis, AWS Lambda, and Amazon MSK.
...
3.  **Question:** Which AWS service is primarily designed for ingesting real-time data streams?
