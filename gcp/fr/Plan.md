# Plan de Présentation : Traitement par Lots vs. en Flux sur Google Cloud

Ce document décrit la structure et le calendrier d'une présentation de 20 minutes sur le traitement par lots (Batch) vs. en flux (Stream) sur Google Cloud, suivie d'un quiz interactif.
...
*   **(4:00 - 5:00)** Services Google Cloud Clés pour le Traitement par Lots
    *   Mentionner brièvement Cloud Storage, Data Fusion, Dataproc et Google Cloud Batch.
...
*   **(8:00 - 9:00)** Services Google Cloud Clés pour le Traitement en Flux
    *   Mentionner brièvement Pub/Sub, Dataflow et Google Cloud Functions.
...
3.  **Question :** Quel service Google Cloud est principalement conçu pour l'ingestion de flux de données en temps réel ?
    *   **Réponse :** Pub/Sub
