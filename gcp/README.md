# Batch vs. Stream Processing on Google Cloud

A presentation outline covering the key concepts, services, and architectures for batch and stream data processing on Google Cloud Platform.
...
*   **Common Use Cases:**
    ...
    *   Genomic sequencing.
*   **Key Google Cloud Services for Batch Processing:**
    *   **Google Cloud Storage:** Data lake storage for raw and processed data.
    *   **Cloud Data Fusion & Dataproc:** Serverless ETL and managed Spark/Hadoop for data preparation and loading.
    *   **Dataproc:** Managed big data platform (Spark, Hadoop, Hive).
    *   **Google Cloud Batch:** Fully managed batch computing for scheduling and executing jobs.
    *   **BigQuery:** Data warehousing for large-scale analytics.
*   **Pros & Cons:**
...
*   **Key Google Cloud Services for Stream Processing:**
    ...
    *   **Dataflow:** For loading, transforming, and processing streaming data (replaces Kinesis Firehose & Analytics).
