# Batch vs. Stream Processing on Microsoft Azure

A presentation outline covering the key concepts, services, and architectures for batch and stream data processing on Microsoft Azure.
...
*   **Common Use Cases:**
    ...
    *   Genomic sequencing.
*   **Key Azure Services for Batch Processing:**
    *   **Azure Blob Storage:** Data lake storage for raw and processed data.
    *   **Azure Data Factory:** Serverless ETL service for data preparation and loading.
    *   **Azure HDInsight & Azure Synapse Analytics:** Managed big data platforms (Spark, Hadoop, Hive).
    *   **Azure Batch:** Fully managed batch computing for scheduling and executing jobs.
    *   **Azure Synapse Analytics:** Data warehousing for large-scale analytics.
*   **Pros & Cons:**
...
*   **Key Azure Services for Stream Processing:**
    *   **Azure Event Hubs:** For ingesting and storing real-time data streams.
    *   **Azure Stream Analytics:** For processing and loading streaming data (replaces Kinesis Firehose & Analytics).
    *   **Azure Functions:** Event-driven, serverless compute for processing individual events.
    *   **Azure Event Hubs for Kafka:** For managed Kafka workflows.
    *   **Azure HDInsight:** For running Spark Streaming or Flink on a managed cluster.
*   **Pros & Cons:**
