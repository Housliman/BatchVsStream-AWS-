# Plan de Présentation : Traitement par Lots vs. en Flux sur Microsoft Azure

Ce document décrit la structure et le calendrier d'une présentation de 20 minutes sur le traitement par lots (Batch) vs. en flux (Stream) sur Microsoft Azure, suivie d'un quiz interactif.
...
*   **(4:00 - 5:00)** Services Azure Clés pour le Traitement par Lots
    *   Mentionner brièvement Azure Blob Storage, Azure Data Factory, Azure HDInsight et Azure Batch.
...
*   **(8:00 - 9:00)** Services Azure Clés pour le Traitement en Flux
    *   Mentionner brièvement Azure Event Hubs, Azure Stream Analytics et Azure Functions.
...
3.  **Question :** Quel service Azure est principalement conçu pour l'ingestion de flux de données en temps réel ?
    *   **Réponse :** Azure Event Hubs
    *   **Options :** Azure Batch, Azure Blob Storage, Azure Synapse Analytics.
