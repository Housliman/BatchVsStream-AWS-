# Traitement par Lots (Batch) vs. en Flux (Stream) sur Microsoft Azure

Un plan de présentation couvrant les concepts clés, les services et les architectures pour le traitement des données par lots et en flux sur Microsoft Azure.
