# Presentation Plan: Batch vs. Stream on Microsoft Azure

This document outlines the structure and timing for a 20-minute presentation on Batch vs. Stream processing on Microsoft Azure, followed by an interactive quiz.
...
*   **(4:00 - 5:00)** Key Azure Services for Batch
    *   Briefly mention Azure Blob Storage, Azure Data Factory, Azure HDInsight, and Azure Batch.
*   **(5:00 - 6:00)** Pros & Cons
...
*   **(8:00 - 9:00)** Key Azure Services for Stream
    *   Briefly mention Azure Event Hubs, Azure Stream Analytics, and Azure Functions.
...
3.  **Question:** Which Azure service is primarily designed for ingesting real-time data streams?
